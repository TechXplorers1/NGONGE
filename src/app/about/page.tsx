...
export default function AboutPage() {
  const [expandedLeader, setExpandedLeader] = React.useState<string | null>(null);
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                To provide unwavering support to federal agencies through
                reliable, efficient, and innovative solutions, enabling them to
                achieve their mission-critical objectives with confidence.
              </p>
            </div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Aligning our goals with our clients' objectives for mission
                      success.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Striving for superior quality and continuous improvement in
                      everything we do.
                    </p>
                  </div>
                </li>
        ...
        <section id="leadership">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            {leadershipTeam.map((leader) => {
              const leaderImage = PlaceHolderImages.find(
                (img) => img.id === leader.imageId
              );
              const isExpanded = expandedLeader === leader.name;
              const previewLength = 180; // Increased preview length

              const bioPreview =
                leader.bio.length > previewLength
                  ? leader.bio.slice(0, previewLength) + "..."
                  : leader.bio;
              ...
              return (
                ...
                >
                  <CardContent className="pt-8 pb-8">
                    {leaderImage && (
                      <div className="relative h-36 w-36 rounded-full mx-auto mb-6 overflow-hidden shadow-md">
                        <Image
                    ...
                    {leader.bio.length > previewLength && (
                      <button
                        onClick={() =>
                          setExpandedLeader(
                            isExpanded ? null : leader.name
                          )
                        }
                        className="mt-3 text-primary font-semibold text-sm hover:underline focus:outline-none transition-colors duration-200"
                      >
        ...
        <section id="timeline">
          ...
          <div className="mt-10 max-w-3xl mx-auto">
            <div className="relative">
              <div
                className="absolute left-3 h-full w-0.5 bg-border"
                aria-hidden="true"
              ></div>
