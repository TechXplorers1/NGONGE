                ...
                <NavigationMenuItem key={link.name}>
                  {link.name === "Services" ? (
                    <>
                      <NavigationMenuTrigger
                        className={cn(
                          "font-medium tracking-widest uppercase bg-transparent text-sm",
                    ...
                    <Link href={link.href} legacyBehavior passHref>
                      <NavigationMenuLink
                        className={cn(navigationMenuTriggerStyle(), "font-medium tracking-widest uppercase bg-transparent text-sm", pathname === link.href ? 'text-primary' : 'text-muted-foreground')}
                      >
                        {link.name}
                      </NavigationMenuLink>
                    </Link>
                ...
                <div className="mt-4 flex flex-col space-y-1">
                  {navLinks.map((link) => (
                    <Link
                      ...
                      onClick={() => setIsMenuOpen(false)}
                      className={cn(
                        "p-3 rounded-l-md text-sm font-medium uppercase tracking-wider transition-colors",
                        pathname === link.href
